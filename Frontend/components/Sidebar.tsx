...
function Sidebar() {
  ...
  return (
    <div className="relativebg-blue-200 dark:bg-gray-800">
      <div className="flex flex-col ">
        <div className="h-screen w-72 bg-red-100">
          <div className="flex items-center justify-start mx-6 mt-10">
            <img
              className="h-10"
              src={session?.user.imageProfile as string}
            />
          ...
          <nav className="mt-10 px-6 ">
            ...
            <a
              className="hover:text-gray-800 hover:bg-gray-100 flex items-center p-2 my-6 transition-colors dark:hover:text-white dark:hover:bg-gray-600 duration-200 border-r-2 border-gray-600 dark:border-gray-300 text-gray-800 dark:text-gray-100 "
              href="#"
            >
              <svg
                width="20"
            ...
            <button className="bg-red-500 p-2 border-r-5 rounded-lg" onClick={()=> signOut()}>
              Log Out
            </button>
          </nav>
        </div>
